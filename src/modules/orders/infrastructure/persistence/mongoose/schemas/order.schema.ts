...
export class Order {
  ...
  /**
   * لحظة تسجيل الفنّي وصوله. مستقلّة عن `startedAt` عمداً: بينهما انتظارٌ
   * حقيقي (العميل يُنهي مكالمة، يفتح الصندوق، يُخرج المركبة) لم يكن يُقاس
   * إطلاقاً — فبدا زمن الخدمة أطول مما هو، وبدا الفنّي واقفاً بلا سبب.
   */
  @Prop()
  arrivedAt?: Date;
