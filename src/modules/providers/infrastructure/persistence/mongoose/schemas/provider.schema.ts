...
export class Provider {
  ...
  // ============================================================
  //  عدّادات الاستجابة للعروض
  //
  //  تُقاس للمراجعة الإدارية ولا تؤثّر آلياً على الإسناد. معاقبة الرفض تبدو
  //  عادلة ونتيجتها عكسية: تدفع الفنّي إلى «القبول ثم الإلغاء» — وهو أسوأ
  //  بكثير للعميل لأنه يكتشف الخذلان بعد دقائق لا فوراً. والأدقّ أن الرفض
  //  الصريح سلوك **جيّد** (يعيد التوزيع فوراً)، بينما ترك المهلة تنقضي هو
  //  الإشارة السلبية الحقيقية.
  // ============================================================
  @Prop({ default: 0 })
