...
export const notificationContent = {
  ...
  /**
   * طلب موجَّه لمزوّد بعينه — الفنّي رفضه أو لم يردّ خلال مهلته. منفصل عمداً
   * عن `noProviderAvailableForOrder`: ذاك يصف نقص تغطية (لا فنّي أصلاً)، وهذا
   * فنّي محدَّد قرّر — لا تصعيد لغيره ولا بحث، فالعبارة لا تَعِد بأي منهما.
   */
  directRequestDeclined(orderNumber: string): NotificationContent {
    return {
      title: 'لم يقبل الفنّي طلبك',
      body: `لم يقبل الفنّي الذي اخترته طلبك رقم ${orderNumber}، وتم إلغاؤه ولم يُخصم منك شيء. يمكنك اختيار فنّي آخر.`,
    };
  },
