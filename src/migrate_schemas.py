...
SCHEMA_MAPPING = {
    ...
    'Booking': 'bookings/infrastructure/persistence/mongoose/schemas/booking.schema',
    ...
    'Subscription': 'subscriptions/infrastructure/persistence/mongoose/schemas/user-subscription.schema', # fallback
    ...
    'PromoCode': 'admin/infrastructure/persistence/mongoose/schemas/promo-code.schema',
