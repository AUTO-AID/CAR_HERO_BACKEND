...
export default () => ({
  ...
  providerApp: {
     ...
     *
     * خمس عشرة ثانية: النافذة تتراكم على العميل لا على الفنّي — خمس محاولات
     * تعني دقيقة وربعاً يقضيها واقفاً على الطريق ينظر إلى «جارٍ البحث»، ومعظم
     * القبولات تقع في الثواني الأولى على أي حال. الثمن أن الفنّي الذي يقود أو
     * يداه تحت سيارة قد تفوته النافذة، وهذا مقبول: الطلب ينتقل فوراً إلى
     * التالي بدل أن ينتظر الجميع واحداً لا يستطيع الردّ.
     */
    offerWindowSeconds: parseInt(process.env.PROVIDER_OFFER_WINDOW_SECONDS || '15', 10),
     ...
     * 3 كم كان مشغولاً لثوانٍ معدودة فقط. التدرّج يمنح القريب أولوية حقيقية
