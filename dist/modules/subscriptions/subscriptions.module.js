    ...
    (0, common_1.Module)({
        imports: [
            mongoose_1.MongooseModule.forFeature([
                { name: subscription_schema_1.SubscriptionPlan.name, schema: subscription_schema_1.SubscriptionPlanSchema },
        ...
        exports: [subscriptions_service_1.SubscriptionsService, mongoose_1.MongooseModule],
    })
], SubscriptionsModule);
