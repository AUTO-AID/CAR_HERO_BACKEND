...
__decorate([
    (0, mongoose_1.Prop)({ type: String, enum: status_enum_1.NotificationType, default: status_enum_1.NotificationType.SYSTEM }),
    __metadata("design:type", String)
...
__decorate([
    (0, mongoose_1.Prop)(),
    __metadata("design:type", String)
], Notification.prototype, "pushError", void 0);
__decorate([
    (0, mongoose_1.Prop)(),
    __metadata("design:type", Date)
...
exports.NotificationSchema.index({ recipientId: 1, recipientType: 1, createdAt: -1 });
