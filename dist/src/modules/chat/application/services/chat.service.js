...
const chat_schema_1 = require("../../../../modules/chat/infrastructure/persistence/mongoose/schemas/chat.schema");
...
exports.ChatService = ChatService = __decorate([
    ...
    __param(1, (0, mongoose_1.InjectModel)(Message.name)),
    __param(2, (0, common_1.Inject)(Symbol.for('IOrderRepository'))),
    __param(3, (0, common_1.Inject)('IBookingRepository')),
    __metadata("design:paramtypes", [mongoose_2.Model,
        mongoose_2.Model, Object, Object, typeof (_a = typeof notifications_service_1.NotificationsService !== "undefined" && notifications_service_1.NotificationsService) === "function" ? _a : Object])
], ChatService);
