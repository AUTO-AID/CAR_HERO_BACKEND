...
const get_admin_transaction_logs_use_case_1 = require("../../application/use-cases/get-admin-transaction-logs.use-case");
const get_financial_summary_use_case_1 = require("../../application/use-cases/get-financial-summary.use-case");
const process_payout_use_case_1 = require("../../application/use-cases/process-payout.use-case");
...
let AdminWalletController = class AdminWalletController {
    ...
    financialSummary;
    processPayout;
    constructor(getBalance, historyUseCase, adminLogsUseCase, financialSummary, processPayout) {
        this.getBalance = getBalance;
        this.historyUseCase = historyUseCase;
        this.adminLogsUseCase = adminLogsUseCase;
    ...
    async handlePayout(id, action, note) {
...
], AdminWalletController.prototype, "getStats", null);
__decorate([
...
__decorate([
    ...
    __metadata("design:returntype", Promise)
], AdminWalletController.prototype, "handlePayout", null);
__decorate([
...
exports.AdminWalletController = AdminWalletController = __decorate([
    ...
    __metadata("design:paramtypes", [get_balance_use_case_1.GetBalanceUseCase,
        ...
        get_admin_transaction_logs_use_case_1.GetAdminTransactionLogsUseCase,
        get_financial_summary_use_case_1.GetFinancialSummaryUseCase,
        process_payout_use_case_1.ProcessPayoutUseCase])
