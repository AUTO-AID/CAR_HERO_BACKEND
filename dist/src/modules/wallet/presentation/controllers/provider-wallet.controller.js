...
let ProviderWalletController = class ProviderWalletController {
    ...
    historyUseCase;
    requestPayout;
    constructor(getBalance, withdrawUseCase, historyUseCase, requestPayout) {
    ...
    async requestPayoutMethod(providerId, dto) {
...
__decorate([
    ...
    __metadata("design:paramtypes", [String, wallet_dto_1.WithdrawDto]),
    __metadata("design:returntype", Promise)
], ProviderWalletController.prototype, "requestPayoutMethod", null);
__decorate([
