...
exports.CreateMaintenanceRecordUseCase = void 0;
...
let CreateMaintenanceRecordUseCase = class CreateMaintenanceRecordUseCase {
    ...
    async execute(vehicleId, dto, userId) {
        ...
        if (!belongsToUser) {
            throw new common_1.ForbiddenException('You do not have permission to add records to this vehicle');
        }
...
exports.CreateMaintenanceRecordUseCase = CreateMaintenanceRecordUseCase;
exports.CreateMaintenanceRecordUseCase = CreateMaintenanceRecordUseCase = __decorate([
...
//# sourceMappingURL=create-maintenance-record.use-case.js.map