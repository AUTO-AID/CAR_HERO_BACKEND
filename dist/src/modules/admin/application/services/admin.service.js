...
const provider_schema_1 = require("../../../../modules/providers/infrastructure/persistence/mongoose/schemas/provider.schema");
const service_schema_1 = require("../../../../modules/services/infrastructure/persistence/mongoose/schemas/service.schema");
const booking_schema_1 = require("../../../../modules/bookings/infrastructure/persistence/mongoose/schemas/booking.schema");
const order_schema_1 = require("../../../../modules/orders/infrastructure/persistence/mongoose/schemas/order.schema");
const subscription_plan_schema_1 = require("../../subscriptions/infrastructure/persistence/mongoose/schemas/subscription-plan.schema");
const user_subscription_schema_1 = require("../../subscriptions/infrastructure/persistence/mongoose/schemas/user-subscription.schema");
...
let AdminService = class AdminService {
    ...
    constructor(adminModel, userModel, providerModel, serviceModel, bookingModel, orderModel, planModel, subscriptionModel, settingModel, jwtService, configService, notificationsService) {
    ...
    async approveProvider(id) {
        ...
        const user = await this.userModel.findOneAndUpdate({ phoneNumber: provider.phone }, { $set: { isActive: true } }, { new: true });
        if (user) {
            await this.notificationsService.createNotification({
                ...
                type: status_enum_2.NotificationType.INFO,
            });
        }
        return {
    ...
    async rejectProvider(id, reason) {
        ...
        if (user) {
            ...
            await this.notificationsService.createNotification({
                ...
                type: status_enum_2.NotificationType.ALERT,
            });
        }
        return {
...
exports.AdminService = AdminService = __decorate([
    ...
    __param(7, (0, mongoose_1.InjectModel)(user_subscription_schema_1.UserSubscription.name)),
    ...
    __metadata("design:paramtypes", [mongoose_2.Model,
        ...
        mongoose_2.Model,
        jwt_1.JwtService,
        config_1.ConfigService, typeof (_a = typeof notifications_service_1.NotificationsService !== "undefined" && notifications_service_1.NotificationsService) === "function" ? _a : Object])
], AdminService);
