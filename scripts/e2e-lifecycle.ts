...
async function runE2E() {
  ...
  try {
    ...
    console.log('✅ Customer registered, activated, and logged in.');
    ...
    const orderRes = await axios.post(`${API_BASE}/orders`, {
      ...
      userLocation: { type: 'Point', coordinates: [36.2765, 33.5138] },
      isScheduled: true,
    ...
    console.log('✅ Order marked as IN_PROGRESS');
