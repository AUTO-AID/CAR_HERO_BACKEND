...
# ── قاعدة البيانات ─────────────────────────────────────────────────────────
# هذا السكربت يكتب $env:MONGODB_URI فوق قيمة .env، ومتغيّر البيئة يتفوّق عليها.
# كان هنا حارس يرفض التشغيل ما لم تُضبط ALLOW_LOCAL_DB=true، من فترة كان فيها
# النظام يعمل على Atlas وكان التشغيل المحلي هو الاستثناء. عاد المشروع كلّه
# (الخلفية والتطبيقان والموقع واللوحتان) إلى القاعدة المحلية، فصار الحارس
# يمنع الحالة الاعتيادية — وأُزيل.
